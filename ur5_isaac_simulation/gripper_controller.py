...
class UR5GripperTrajController(Node):
    ...
    Joint relationships in IsaacSim:
    ...
    /World/Robots/ur5_robot/robotiq_arg2f_140_model/left_inner_finger/visuals
    /World/Robots/ur5_robot/robotiq_arg2f_140_model/left_inner_knuckle/visuals
    ...
    def __init__(self):
        ...
        self.joint_directions_close = self.ros_parameters['joint_directions_close']
    ...
    async def execute_trajectory(
        ...
        if goal_handle is not None:
            ...
            while not position_in_tol and in_time:
                ...
                for i in range(self.n_joints):
                    position[i] = self.joint_directions_close[i]*abs(position[i])
